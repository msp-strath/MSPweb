...
generateHTML ts out = do
  ...
  let upcoming = if null upcomingTalks then "" else unlines ["<h2>Upcoming talks</h2>",
      ...
      header = unlines ["### default.html(section.msp101=current,headtags=<link rel='alternate' type='application/rss+xml' title='MSP101 seminars RSS feed' href='/msp101.rss'/>)",
                        ...
                        "<h2>MSP101</h2>",
                        "<p>MSP101 is an ongoing series of informal talks by visiting academics or members of the MSP group. The talks are usually " ++ usualDay ++ " " ++ formattedTime ++ " in room LT1310 in Livingstone Tower. They are announced on the <a href='https://lists.cis.strath.ac.uk/mailman/listinfo/msp-interest'>msp-interest</a> mailing-list. The list of talks is also available as a <a type='application/rss+xml' href='/msp101.rss'><img src='/images/feed-icon-14x14.png' alt='feed icon'>RSS feed</a> and as a <a href='msp101.ics'>calendar file</a>. <b>Due to COVID-19, the MSP 101 seminar is now held online. The Zoom link can be found on the msp-interest mailing list and the SPLS Zulipchat.</b></p>"]
